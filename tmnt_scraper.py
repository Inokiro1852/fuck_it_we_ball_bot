...
#             )
#             ''')
cur.execute("UPDATE cards SET image_url = ? WHERE image_url = ?",
            ("AgACAgIAAxkBAAIEB2nMaH9ql9sIyG9pOXc4-5FspPdMAAJfFGsbt_RoSlv_wdAs8qwjAQADAgADeQADOgQ",
             f'AgACAgIAAxkDAAICTGnMPRxTVu9DrwNbQBmmtv8NCdMiAAK9HGsbt_RgSqKs4vhqx7WzAQADAgADeAADOgQ'))
conn.commit()
